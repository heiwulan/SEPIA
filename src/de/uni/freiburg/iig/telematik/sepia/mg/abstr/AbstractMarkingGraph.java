...
public abstract class AbstractMarkingGraph<M extends AbstractMarking<O>, 
                                           O extends Object, 
                                           S extends AbstractMarkingGraphState<M,O>, 
                                           R extends AbstractLabeledTransitionRelation<S,Event,M>> 
                      extends AbstractLabeledTransitionSystem<Event,S,R,M> {
